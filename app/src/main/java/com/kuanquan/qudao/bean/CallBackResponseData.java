 ...
 * http://t.apidea.gaodun.com/Zhibo?act=getAllHFList&student_id=13183&is_handle_token=no
 */

public class CallBackResponseData implements Serializable {
    public String ret  ;
    public String status  ;
    public List<Data> data; // 精彩回放
