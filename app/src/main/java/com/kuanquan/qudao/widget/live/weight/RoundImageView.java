package com.kuanquan.qudao.widget.live.weight;
...
/**
 * https://blog.csdn.net/sure_min/article/details/79102226
 */
...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderRadius = array.getDimensionPixelSize(R.styleable.RoundImageView_borderRadius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, BODER_RADIUS_DEFAULT, getResources().getDisplayMetrics()));
        array.recycle();
    }
    ...
    /**
     * 设置圆角半径     *     * @param borderRadius 半径，单位dp
     */
    ...
    /**
     * 设置填充类型     *     * @param scaleType 填充类型，可选项：SCALE_TYPE_CROP、SCALE_TYPE_FIT
     */
    ...
    /**
     * 设置显示类型     *     * @param type 显示类型，可选项：TYPE_CIRCLE（圆形）、TYPE_ROUND（圆角）
     */
