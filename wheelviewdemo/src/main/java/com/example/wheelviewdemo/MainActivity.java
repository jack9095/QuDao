...
import com.example.wheelviewdemo.bean.CardBean;
import com.example.wheelviewdemo.bean.ProvinceBean;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TimePickerView pvTime, pvCustomTime, pvCustomLunar,yndTime;
    private OptionsPickerView pvOptions, pvCustomOptions, pvNoLinkOptions,pvProjectOptions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_yn).setOnClickListener(this);
        findViewById(R.id.btn_ynd).setOnClickListener(this);
    ...
    public void onClick(View view) {
        Log.e(TAG,"点击事件");
        switch (view.getId()) {
            case R.id.btn_lunar:  // 公农历切换
                Log.e(TAG,"公农历切换");
                pvCustomLunar.show();
                break;
            case R.id.btn_Time:  //弹出时间选择器，传递参数过去，回调的时候则可以绑定此view   时间选择器
                if (pvTime != null) {
                    pvTime.show();
                }
                break;
            ...
            case R.id.btn_GotoJsonData:  //跳转到 省市区解析示例页面
                ...
                break;
            case R.id.btn_fragment:  //跳转到 fragment  自定义容器
                Log.e(TAG,"自定义容器");
    ...
    private void initProjectPicker() {
        ...
        pvProjectOptions = new OptionsPickerBuilder(this, new OnOptionsSelectListener() {
            @Override
...
//                .setSubmitColor(Color.YELLOW)
                ...
                .setLineSpacingMultiplier(2.2f)//设置两横线之间的间隔倍数
...
//        pvProjectOptions.setSelectOptions(1,1);
        pvProjectOptions.setPicker(options1Items);//一级选择器
//        pvProjectOptions.setPicker(options1Items, options2Items);//二级选择器
        /*pvProjectOptions.setPicker(options1Items, options2Items,options3Items);//三级选择器*/
    }
    ...
    private void initYNDPicker() {
        ...
        endDate.set(2100, 11, 30);
        //时间选择器 ，自定义布局
        yndTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date, View v) {//选中事件回调
                Toast.makeText(MainActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
            }
                ...
                .setDate(selectedDate)
                .setRangDate(startDate, endDate)
                .setLayoutRes(R.layout.pickerview_custom_ynd, new CustomListener() {
                ...
                .setType(new boolean[]{true, true, false, false, false, false})  // 这里设置显示年月日时分秒 true显示 false 不显示
                .isCenterLabel(false) //是否只显示中间选中项的label文字，false则每项item全部都带有label。
                .setDividerColor(Color.RED)
                .build();
    }
